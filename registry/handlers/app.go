...
func NewApp(ctx context.Context, configuration configuration.Configuration) *App {
	...
	if registryHandlerType != "" {
		rh, err := storage.GetRegistryHandler(registryHandlerType, app.registry, configuration.RegistryHandler.Parameters())
		if err != nil {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if app.nameRequired(r) {
			...
			if repositoryHandlerType != "" {
				rh, err := storage.GetRepositoryHandler(repositoryHandlerType, context.Repository, app.Config.RepositoryHandler.Parameters())
				if err != nil {
